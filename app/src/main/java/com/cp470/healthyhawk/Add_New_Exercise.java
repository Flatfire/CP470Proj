...
public class Add_New_Exercise extends AppCompatActivity {
    // Constants
    public static final String ACTIVITY_NAME = "Add_New_Exercise";
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!textViewQuantity.getText().toString().equals("")) {
                    ...
                    SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd/MM/yyyy KK:mm aaa");

                    // Get data values
                    String activityType = spinnerType.getSelectedItem().toString();
                    String activityStatNum = textViewQuantity.getText().toString();
                    // Error handling: Number does not parse as Double -> Just pass as String
                    try {
                        if (Double.valueOf(activityStatNum) % 1.0 == 0)
                            activityStatNum = String.valueOf(Integer.valueOf(activityStatNum));
                    } catch(Exception e) {
                        Log.i(ACTIVITY_NAME, "Quantity could not be parsed as Double, passing as String instead.");
                    }
